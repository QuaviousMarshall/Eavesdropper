...
Android-приложение — **AI-ассистент на основе GPT-5 Nano (OpenAI) и Гигачат (Сбер)**, реализованный с применением production-подхода к архитектуре, DI и сетевому взаимодействию.
...
* предоставляет функционал выбора модели ИИ;
...
* отправляет запрос через OpenAI API (GPT-5 Nano) или Гигачат;
